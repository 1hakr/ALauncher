...
public class LockTimeoutActivity extends Activity {
    ...
    public static void startTimeout(Context context) {
        context.startActivity(new Intent(context, LockTimeoutActivity.class));
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            CrashHelper.logException(new Exception("Error writing Settings.System.SCREEN_OFF_TIMEOUT", t));
        }
        try {
            Settings.System.putInt(getContentResolver(), Settings.Global.STAY_ON_WHILE_PLUGGED_IN, 0);
        } catch (Throwable t) {
            CrashHelper.logException(new Exception("Error writing Settings.Global.STAY_ON_WHILE_PLUGGED_IN", t));
        }
    }
