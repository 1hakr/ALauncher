...
public class HotseatQsbWidget extends AbstractQsbLayout {
    ...
    private void setColors() {
        ...
        int color = Settings.isBottomSearchBarDark(getContext())
                ? R.color.qsb_dark_color
                : (mIsDefaultLiveWallpaper || Settings.isColoredGIconForced(getContext()))
                    ? R.color.qsb_background_hotseat_white : R.color.qsb_background_hotseat_default;
