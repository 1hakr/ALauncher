...
public class PreferenceUtils {
	...
	public static Boolean getBooleanPrefs(String key, boolean defaultValue) {
		return PreferenceManager.getDefaultSharedPreferences(App.getInstance().getBaseContext()).getBoolean(key, defaultValue);
	}

	public static String getStringPrefs(String key) {
		return PreferenceManager.getDefaultSharedPreferences(App.getInstance().getBaseContext()).getString(key, "");
	}
	...
	public static int getIntegerPrefs(String key) {
		return PreferenceManager.getDefaultSharedPreferences(App.getInstance().getBaseContext()).getInt(key, 0);
	}
	...
	public static Long getLongPrefs(String key) {
		return PreferenceManager.getDefaultSharedPreferences(App.getInstance().getBaseContext()).getLong(key, 0);
	}
	...
	public static Set<String> getStrinSetPrefs(String key) {
		return PreferenceManager.getDefaultSharedPreferences(App.getInstance().getBaseContext()).getStringSet(key, new HashSet<String>());
	}
