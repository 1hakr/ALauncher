...
import dev.dworks.apps.alauncher.client.ILauncherClientProxy
...
class ProxyImpl(val context: Context) : ILauncherClientProxy.Stub() {
    ...
    override fun init(callback: ILauncherClientProxyCallback): Int {
        allowed = "com.universallauncher.universallauncher" == callingPackage
        enforcePermission()
        ...
        override fun onServiceDisconnected(name: ComponentName) {
            if (name.packageName == packageName) {
                try {
                    ...
                    Log.e(TAG, "onServiceDisconnected, impossible to assign sApplicationConnection to NULL!");
                }
            }
        }
    }
    ...
    private inner class OverlayServiceConnection : ServiceConnection {
        override fun onServiceConnected(name: ComponentName, service: IBinder) {
            try {
                ...
                Log.e(TAG, "onServiceConnected, impossible to connect to the service");
            }
        }
        ...
        override fun onServiceDisconnected(name: ComponentName) {
            try {
                ...
                Log.e(TAG, "onServiceDisconnected, impossible to disconnect from service");
            }
        }
    }
