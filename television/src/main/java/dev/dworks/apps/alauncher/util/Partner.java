package dev.dworks.apps.alauncher.util;
...
public class Partner {
    ...
    public AppsManager.SortingMode getAppSortingMode() {
        ...
        if (nameResId != 0) {
            return AppsManager.SortingMode.valueOf(this.mResources.getString(nameResId).toUpperCase(Locale.ENGLISH));
        }
        return isRowEnabled("partner_row") ? AppsManager.SortingMode.RECENCY : AppsManager.SortingMode.FIXED;
    }
