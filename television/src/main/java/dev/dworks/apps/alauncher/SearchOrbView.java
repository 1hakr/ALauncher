...
import dev.dworks.apps.alauncher.apps.AppsManager.SearchPackageChangeListener;
        ...
        OnClickListener listener = new OnClickListener() {
            public void onClick(View view) {
                ...
                if (!finalIsTouchExplorationEnabled) {
                    ...
                    success = Util.startSearchActivitySafely(SearchOrbView.this.mContext, SearchOrbView.this.mSearchIntent, iskeyboardSearch) && SearchOrbView.this.mListener != null;
                if (success) {
